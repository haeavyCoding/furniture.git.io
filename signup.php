            ...
            <div class="col-lg-10 contact-info col-md-12 col-sm-12">
                ...
                <form class="row g-3 mt-4 contact-form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                    ...
                    <div class="col-lg-6 col-md-6">
                     ...
                     <div class="col-auto">
                        <input type="submit" name="signup" class="btn py-2 fs-4 mb-3 px-5 rounded-pill text-white" value="Sign Up" style="background:#3b5d50;">
                        <a class="btn btn-primary  mb-3 py-2 fs-4 px-5 rounded-pill text-white" href="login.php">Log In</a>
                    </div> 
                </form>
            </div>
